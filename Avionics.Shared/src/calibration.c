...
#define ACCEL_MXX 0.002066242965070f
#define ACCEL_MXY 0.000065665238508f
#define ACCEL_MXZ -0.000032741787394f
#define ACCEL_MYY 0.002308011526605f
#define ACCEL_MYZ 0.000045945453937f
#define ACCEL_MZZ 0.002060579606010f
#define ACCEL_OX 7.984003003622127f
#define ACCEL_OY -58.622941461088537f
#define ACCEL_OZ 83.335407198788403f
