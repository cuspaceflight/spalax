...
#define GPIOA_ADIS_CS                  2U
#define GPIOA_ADIS_NRST                3U
...
#define GPIOB_MPU_IRQ                  11U
#define GPIOB_MPU_CS                   12U
#define GPIOB_IMU_SCLK                 13U
...
#define LINE_ADIS_CS                   PAL_LINE(GPIOA, 2U)
#define LINE_ADIS_IRQ                  PAL_LINE(GPIOC, 5U)
#define LINE_ADIS_NRST                 PAL_LINE(GPIOA, 3U)
...
#define LINE_IMU_MISO                  PAL_LINE(GPIOB, 14U)
#define LINE_IMU_MOSI                  PAL_LINE(GPIOB, 15U)
#define LINE_IMU_SCLK                  PAL_LINE(GPIOB, 13U)
...
#define VAL_GPIOA_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOA_PIN0) | \
                                        ...
                                        PIN_OTYPE_PUSHPULL(GPIOA_ADIS_CS) | \
...
#define VAL_GPIOA_OSPEEDR              (PIN_OSPEED_HIGH(GPIOA_PIN0) | \
                                        ...
                                        PIN_OSPEED_HIGH(GPIOA_ADIS_CS) | \
                                        PIN_OSPEED_HIGH(GPIOA_ADIS_NRST) | \
...
#define VAL_GPIOA_PUPDR                (PIN_PUPD_PULLUP(GPIOA_PIN0) | \
                                        ...
                                        PIN_PUPD_PULLUP(GPIOA_ADIS_CS) | \
                                        PIN_PUPD_PULLUP(GPIOA_ADIS_NRST) | \
...
#define VAL_GPIOA_ODR                  (PIN_OD_HIGH(GPIOA_PIN0) | \
                                        ...
                                        PIN_OD_HIGH(GPIOA_ADIS_CS) | \
                                        PIN_OD_HIGH(GPIOA_ADIS_NRST) | \
...
#define VAL_GPIOA_AFRL                 (PIN_AFIO_AF(GPIOA_PIN0, 0U) | \
                                        ...
                                        PIN_AFIO_AF(GPIOA_ADIS_CS, 0U) | \
                                        PIN_AFIO_AF(GPIOA_ADIS_NRST, 0U) | \
...
#define VAL_GPIOB_MODER                (PIN_MODE_INPUT(GPIOB_PIN0) | \
                                        ...
                                        PIN_MODE_ALTERNATE(GPIOB_IMU_SCLK) | \
...
#define VAL_GPIOB_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) | \
                                        ...
                                        PIN_OTYPE_PUSHPULL(GPIOB_IMU_SCLK) | \
...
#define VAL_GPIOB_OSPEEDR              (PIN_OSPEED_HIGH(GPIOB_PIN0) | \
                                        ...
                                        PIN_OSPEED_HIGH(GPIOB_IMU_SCLK) | \
                                        PIN_OSPEED_HIGH(GPIOB_IMU_MISO) | \
                                        PIN_OSPEED_HIGH(GPIOB_IMU_MOSI))
#define VAL_GPIOB_PUPDR                (PIN_PUPD_PULLUP(GPIOB_PIN0) | \
                                        ...
                                        PIN_PUPD_PULLUP(GPIOB_IMU_SCLK) | \
                                        PIN_PUPD_PULLUP(GPIOB_IMU_MISO) | \
                                        PIN_PUPD_PULLUP(GPIOB_IMU_MOSI))
#define VAL_GPIOB_ODR                  (PIN_OD_HIGH(GPIOB_PIN0) | \
                                        ...
                                        PIN_OD_HIGH(GPIOB_IMU_SCLK) | \
                                        PIN_OD_HIGH(GPIOB_IMU_MISO) | \
                                        PIN_OD_HIGH(GPIOB_IMU_MOSI))
...
#define VAL_GPIOB_AFRH                 (PIN_AFIO_AF(GPIOB_CAN_RX, 9U) | \
                                        ...
                                        PIN_AFIO_AF(GPIOB_IMU_SCLK, 5U) | \
                                        PIN_AFIO_AF(GPIOB_IMU_MISO, 5U) | \
                                        PIN_AFIO_AF(GPIOB_IMU_MOSI, 5U))
 ...
 * PC4  - BARO_CS                      (output).
 * PC5  - ADIS_IRQ                     ().
 * PC6  - LED_RED                      (output, startlow).
 * PC7  - LED_GREEN                    (output, startlow).
 * PC8  - PIN8                         (unused).
 * PC9  - PIN9                         (unused).
 * PC10 - PIN10                        (unused).
 * PC11 - PIN11                        (unused).
...
#define VAL_GPIOC_OSPEEDR              (PIN_OSPEED_HIGH(GPIOC_PIN0) | \
                                        ...
                                        PIN_OSPEED_HIGH(GPIOC_ADIS_IRQ) | \
...
#define VAL_GPIOC_PUPDR                (PIN_PUPD_PULLUP(GPIOC_PIN0) | \
                                        ...
                                        PIN_PUPD_PULLUP(GPIOC_ADIS_IRQ) | \
                                        PIN_PUPD_PULLUP(GPIOC_LED_RED) | \
                                        PIN_PUPD_PULLUP(GPIOC_LED_GREEN) | \
...
#define VAL_GPIOC_ODR                  (PIN_OD_HIGH(GPIOC_PIN0) | \
                                        ...
                                        PIN_OD_HIGH(GPIOC_ADIS_IRQ) | \
                                        PIN_OD_LOW(GPIOC_LED_RED) | \
                                        PIN_OD_LOW(GPIOC_LED_GREEN) | \
