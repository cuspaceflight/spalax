...
// Sensor Covariances
fp kalman_magno_cov = 0.001f;
fp kalman_accelerometer_cov = 0.001f;
fp kalman_gyro_cov = 0.001;
...
fp initial_gyro_bias_cov = 0;
fp gyro_bias_process_noise = 0;

fp initial_accel_bias_cov = 0;
fp accel_bias_process_noise = 0;
